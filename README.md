...
1. What is the purpose of using _sessions_?
   So that the user session is stored in the database and data can persist across requests.
1. What does bcrypt do to help us store passwords in a secure manner.
   Automatically encrypts passwords by hashing them.
1. What does bcrypt do to slow down attackers?
   If a hacker accesses a hashed password, they must know which hashing algorithm was used and how many times it was hashed, so this adds more layers of protection to stored passwords.
